...
public struct Answer<Success>
{
    ...
    private Answer(Success success)
    {
        _success = success;
        _fail = default;
        _isSuccess = true;
    ...
    public static implicit operator Answer<Success>(Success left)
    {
        return new Answer<Success>(left);
    }
    ...
    /// </summary>
    /// <param name="left"></param>
    public static implicit operator Answer<Success>(Error error)
    {
        return new Answer<Success>(error);
    }
